...
class Graficos extends Controller
{
    ...
    public function getDados($id = null)
    {
        ...
        $query = $model->query("SELECT c.idCaso as id, c.created_at as dat, c.confirmadosCaso as conf, c.suspeitosCaso as susp, c.obitosCaso as ob, c.descartadosCaso as desca, c.recuperadosCaso as recu, m.nomeMunicipio as nome FROM casos c, municipios m WHERE m.idMunicipio = c.idMunicipio AND c.idMunicipio = ".$id." ORDER BY created_at ASC");
